...
本项目「AcFun Evolved」采用 **Mozilla Public License 2.0（MPL 2.0）** 协议进行分发。
...
本項目「AcFun Evolved」採用 **Mozilla Public License 2.0（MPL 2.0）** 協議進行分發。
...
The project "AcFun Evolved" is distributed under the **Mozilla Public License 2.0 (MPL 2.0)**.
...
This project is licensed under the MPL 2.0 license, authorized by Nick Hsu on January 10, 2024.
